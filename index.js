...
var CHAT_ID = 698998391;
var bitbankApi = new bitbank.PublicApi(bitbankApiConf);
// import * as TelegramBot from 'node-telegram-bot-api';
var TelegramBot = require('node-telegram-bot-api');
var telegramBotToken = process.env.TELEGRAM_CRYPTO_PRICE_BOT_TOKEN;
var bot = new TelegramBot(telegramBotToken, { polling: true });
function getMonaCoinLatestPrice(api) {
    return __awaiter(this, void 0, void 0, function () {
        var monaTicker, monaLastPrice;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api.getTicker({
                        pair: 'mona_jpy'
                    })];
                case 1:
                    monaTicker = _a.sent();
                    monaLastPrice = monaTicker.data.last;
                    if (!monaLastPrice) {
                        throw Error();
                    }
                    return [2 /*return*/, +monaLastPrice];
            }
        });
    });
}
